...
const VITE_RAZORPAY_KEY_ID = 'rzp_live_Ap0i4wR26uP4WR'; // Replace with your key
...
const Donate = ({ navigation }) => {
  ...
  const presetAmounts =
    activeTab === 'personal' ? personalPresetAmounts : businessPresetAmounts;
  const minAmount = activeTab === 'personal' ? 10 : 200;
  ...
  const validateDonateForm = (data, tab) => {
    ...
    // Donation Amount
    const minimum = tab === 'personal' ? 10 : 200;
    ...
    <View className="flex-1 bg-gray-50">
      ...
      >
        ...
        <View className="flex-row bg-gray-200 rounded-lg p-1 mb-6">
          ...
          >
            <Text
              className={`text-center text-base font-medium ${
                activeTab === 'personal' ? 'text-blue-600' : 'text-gray-600'
              }`}
            >
              Personal
            </Text>
          ...
          <TouchableOpacity
            className={`flex-1 py-3 rounded-md ${
              activeTab === 'business' ? 'bg-white' : ''
            }`}
            onPress={() => handleTabChange('business')}
          >
            <Text
              className={`text-center text-base font-medium ${
                activeTab === 'business' ? 'text-blue-600' : 'text-gray-600'
              }`}
            >
              Business
            </Text>
        ...
        <View className="mb-5">
          ...
          <TextInput
            className={`bg-white border rounded-lg px-3 py-2.5 text-base text-gray-800 ${
...
<View className="mb-5">
  ...
  <TextInput
    className={`bg-white border rounded-lg px-4 py-4 text-lg text-gray-800 ${
        ...
        {activeTab === 'business' && (
          <View className="mb-5">
            ...
            <TouchableOpacity
              ...
              className={`bg-white border-2 border-dashed rounded-lg p-5 items-center justify-center ${
