...
import { User, ChevronRight, ChevronLeft, Users } from 'react-native-feather';
      ...
      const checkAuth = async () => {
        try {
          ...
          if (userData) {
            ...
            navigation.reset({ index: 0, routes: [{ name: 'BusinessLanding' }] });
          }
        } catch (e) {
          // ignore
        }
  ...
  return (
    <View className="flex-1 relative">
      ...
      <SafeAreaView className="flex-1 px-6 pt-6 pb-4 justify-between">
        ...
        {/* CTA */}
        <View>
          <Animatable.View animation="fadeInLeft" delay={400} duration={900} className="">
            ...
            >
              <TouchableOpacity
                onPress={() => navi.navigate('Login', { type: 'user' })}
                activeOpacity={0.95}
                  ...
                  return (
                    ...
                    >
                      ...
                      <View className="flex-1">
                        ...
                        <Text className={`${isDark ? 'text-slate-200' : 'text-slate-700'}`}>Login to User</Text>
                      </View>
          ...
          <Animatable.View animation="fadeInRight" delay={400} duration={900} className="my-10">
            {/* Gradient bordered CTA for a premium feel */}
            <LinearGradient
              colors={[ORANGE_DARK, ORANGE]}
              start={{ x: 0, y: 0 }}
            ...
            >
              <TouchableOpacity
                onPress={() => navi.navigate('Login', { type: 'business' })}
                activeOpacity={0.95}
                className="rounded-xl flex-row items-center"
                style={{
                  backgroundColor: isDark ? 'rgba(255,255,255,0.08)' : 'rgba(255,255,255,0.55)',
                ...
                {(() => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Animatable.View animation="fadeInRight" delay={700}>
                        <ChevronLeft color={isDark ? '#ffffff' : '#111827'} width={26} height={26} />
                      </Animatable.View>

                      <View className="flex-1 mr-4">
                        <Text className={`${isDark ? 'text-white' : 'text-slate-900'} text-xl text-right font-bold mb-0.5`}>Get Started</Text>
                        <Text className={`${isDark ? 'text-slate-200' : 'text-slate-700'} text-right`}>Login to Business</Text>
                      </View>
                      <Animatable.View animation="bounceIn" delay={500} className="bg-white p-4 rounded-full mr-4">
                        <Users color={ORANGE} width={28} height={28} />
                      </Animatable.View>
                    </Animated.View>
                  );
                })()}
